  ...
  return (
    <div className="bg-[#e5e5e5] dark:bg-[#1a1a1a] min-h-screen py-8">
      ...
      <div className="max-w-[210mm] mx-auto mb-6 flex items-center justify-between px-4">
        <button onClick={() => navigate('/cadernos')} className="text-gray-600 dark:text-gray-300 hover:text-black dark:hover:text-white flex items-center gap-2 bg-white/50 dark:bg-black/50 backdrop-blur px-3 py-1.5 rounded-full shadow-sm">

    ...
    "Cardiologia": {
      ...
      "subtopicos": {
        "IAM e Síndromes Coronarianas Agudas": [
          "infarto agudo","iam","sca","angina instavel","angina estavl",
        ...
        "Insuficiência Cardíaca": [
          ...
          "feve reduzida","feve preservada","classe nyha","edema agudo pulmao",
        ...
        "Arritmias e Distúrbios de Condução": [
          "fibrilacao atrial","flutter","taquicardia supraventricular","tsv",
        ...
        "Hipertensão Arterial Sistêmica": [
          "hipertensao arterial","has ","crise hipertensiva","emergencia hipertensiva",
          "urgencia hipertensiva","pressao arterial","anti-hipertensivo",
          "amlodipina","enalapril","losartana","captopril","hidroclorotiazida",
          "lesao de orgao alvo","retinopatia hipertensiva",
        ],
    ...
    "Gastroenterologia": {
      ...
      "subtopicos": {
        ...
        "Hemorragia Digestiva": [
          ...
          "melena","hematoquecia","hematemese","varizes esofagicas san",
          "ulcera sangrante","endoscopia terapeutica","escleroterapia",
          "band ligadura","angiodisplasia","diverticulo sangramento",
        ],
        "Câncer Gastrointestinal": [
          "cancer gastrico","adenocarcinoma gastrico","cancer colorretal",
          "carcinoma colorretal","polipose adenomatosa","lynch",
          "rastreamento colonoscopia","cirurgia cancer gastrico",
          "gastrectomia oncologica",
        ],
        "Pancreatite e Doenças Pancreáticas": [
          "pancreatite cronica","pancreatite aguda nao cirurgica","ca pancreas",
          "cancer de pancreas","insuficiencia pancreatica","esteatorreia",
          "lipase","amilase pancreat","pseudocisto pancreatico",
        ],
      },
    },
...
"Pediatria": {
  ...
  "temas": {
    ...
    "Pneumologia Pediátrica": {
      ...
      "default_sub": "Asma e Sibilância Pediátrica",
      "subtopicos": {
        "Asma e Sibilância Pediátrica": [
          "asma pediatrica","asma na crianca","crise asmatica infantil",
          "sibilancia","wheeze","wheezing","lactente sibilante",
          "broncoespasmo","corticoide inalado crianca","beta2 agonista crianca",
          "step asma pediatrica","gina pediatrico","espirometria crianca",
        ],
        "Bronquiolite e Infecções Respiratórias": [
          "bronquiolite","vsr","virus sincicial respiratorio",
          "pneumonia bacteriana crianca","broncopneumonia","pneumonia crianca",
          "antibiotico pneumonia infantil","radiografia torax crianca",
          "influenza pediatrica","coqueluche","bordetella pertussis",
        ],
        "Laringite, Crupe e Epiglotite": [
          "laringite aguda","laringotraqueobronquite","crupe","estridor inspiratorio",
          "epiglotite","difteria","fibrocartilagem laringea",
          "dexametasona crupe","epinefrina racemia","umidificacao crupe",
        ],
      },
    },
    ...
    "Obstetrícia": {
      ...
      "subtopicos": {
        ...
        "Puerpério e Hemorragia Pós-Parto": [
          "puerperio","pos-parto","involucao uterina","loquios","amamentacao pós-parto",
          "hemorragia pos-parto","hpp","atonia uterina","laceracao perineal",
          "trauma obstétrico","retencao placenta","curetagem puerperal",
          "depressao pos-parto","psicose puerperal","mastite puerperal",
...
"Medicina Preventiva": {
  ...
  "temas": {
    ...
    "Atenção Primária": {
      ...
      "default_sub": "Princípios do SUS e Atenção Básica",
      "subtopicos": {
        "Princípios do SUS e Legislação": [
          "lei 8080","lei 8142","decreto 7508","nob","noas","norma operacional",
        ...
        "Princípios do SUS e Atenção Básica": [
        ...
        "Rastreamento e Níveis de Prevenção": [
          ...
          "prevencao quaternaria","sobrediagnostico","medicalizacao",
        ],
      },
    },
